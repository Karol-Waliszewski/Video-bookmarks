...
const RouterCustomModule = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forRoot(ROUTES);
...
let IframePipe = class IframePipe {
...
let VideoService = class VideoService {
    ...
    addVideo(input) {
        if (input.includes("youtu")) {
            let id = input.match(/(?:youtu\.be\/|youtube\.com(?:\/embed\/|\/v\/|\/watch\?v=|\/user\/\S+|\/ytscreeningroom\?v=|\/sandalsResorts#\w\/\w\/.*\/))([^\/&]{10,12})/)[1];
...
let ToolbarComponent = class ToolbarComponent {
    constructor(videoService, layoutService) {
        this.videoService = videoService;
...
let VideoDialogComponent = class VideoDialogComponent {
...
let VideoListItemComponent = class VideoListItemComponent {
    constructor() {
        this.onDelete = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.onFavourite = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.onDialog = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
let VideoTilesComponent = class VideoTilesComponent {
...
let VideoViewComponent = class VideoViewComponent {
    constructor(videoService, layoutService, snackBar, dialog, route) {
        this.videoService = videoService;
        this.layoutService = layoutService;
